// src/app/(dashboard)/profile/page.tsx - Enhanced with Left Nav & Optimizations
'use client'
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          {subscription?.plan_name === 'Starter' && (
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              <div className="bg-white/80 backdrop-blur-xl rounded-xl shadow-lg border border-white/50 p-6 hover:shadow-xl transition-all hover:-translate-y-1">
                      ...
                      subscription.status === 'active' && (
                        <div className="mt-8 p-6 bg-red-50 rounded-xl border border-red-200">
                          ...
                          <p className="text-sm text-red-700 mb-4">
                            ...
                            continue to have access to your current plan until
