// src/components/UnifiedPublisher.tsx - FINAL FIX for black screen
'use client'
...
export default function UnifiedPublisher({
  ...
  return (
    <div className="mt-6 space-y-6">
      {/* Amazon Instructions Modal - COMPLETELY FIXED */}
      {showInstructions && instructionData && (
        <div className="fixed inset-0 z-50 flex items-start justify-center p-4 bg-black bg-opacity-50">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {/* Footer */}
            <div className="bg-gray-100 p-4 rounded-b-xl border-t sticky bottom-0">
              <div className="flex items-center justify-between">
